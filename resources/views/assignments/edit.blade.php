            ...
            <div class="max-w-2xl mx-auto">
                <form method="POST" action="{{ route('assignments.update', $assignment) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-input id="title" type="text" name="title" :value="old('title', $assignment->title)" required
                            autofocus class="block w-full mt-1" />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $assignment->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <select id="task_id" name="task_id" required
                            ...
                            <option value="{{ $task->id }}" {{ old('task_id', $assignment->task_id) == $task->id ?
                                'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select id="user_id" name="user_id" required
                            ...
                            <option value="{{ $user->id }}" {{ old('user_id', $assignment->user_id) == $user->id ?
                                'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" required
                            ...
                            <option value="{{ $status->value }}" {{ old('status', $assignment->status->value) ==

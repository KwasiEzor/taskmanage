<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-button class="btn-black" wire:click="confirmLogout" wire:loading.attr="disabled">
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-button class="ms-3 btn-black" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    {{ __('Log Out Other Browser Sessions') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
